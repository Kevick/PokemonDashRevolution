...
local pokemons = {
{name = "Golem", optionalLevel = 400, sex = SEX_MALE, nick = "Brock's Golem", ball = "poke"},
{name = "Rhydon", optionalLevel = 300, sex = SEX_MALE, nick = "Brock's Rhydon", ball = "poke"},   --alterado v1.3
{name = "Graveler", optionalLevel = 400, sex = SEX_MALE, nick = "Brock's Steelix", ball = "poke"},
{name = "Onix", optionalLevel = 300, sex = SEX_MALE, nick = "Brock's Onix", ball = "poke"},
...
local function doSummonGymPokemon(npc)
	...
	doCreatureSetNick(pokeNpc, it.nick)

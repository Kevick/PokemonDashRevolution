...
local pokemons = {
{name = "Gyarados", optionalLevel = 450, sex = SEX_MALE, nick = "", ball = "poke"},
{name = "Tentacruel", optionalLevel = 450, sex = SEX_MALE, nick = "", ball = "poke"},
{name = "Vaporeon", optionalLevel = 450, sex = SEX_FEMALE, nick = "", ball = "poke"},
{name = "Golduck", optionalLevel = 450, sex = SEX_MALE, nick = "", ball = "poke"},
{name = "Blastoise", optionalLevel = 450, sex = SEX_MALE, nick = "", ball = "poke"},
{name = "Starmie", optionalLevel = 450, sex = SEX_FEMALE, nick = "", ball = "poke"},
}
...
local function doWinDuel(cid, npc)
	...
	setPlayerStorageValue(cid, 993, 1)
end

...
local pokemons = {
{name = "Wigglytuff", optionalLevel = 650, sex = SEX_FEMALE, nick = "", ball = "poke"},
{name = "Pidgeot", optionalLevel = 700, sex = SEX_FEMALE, nick = "", ball = "poke"},
{name = "Lickitung", optionalLevel = 750, sex = SEX_FEMALE, nick = "", ball = "poke"},
{name = "Ursaring", optionalLevel = 750, sex = SEX_MALE, nick = "", ball = "poke"},
{name = "Snorlax", optionalLevel = 700, sex = SEX_MALE, nick = "", ball = "poke"},
{name = "Miltank", optionalLevel = 750, sex = SEX_MALE, nick = "", ball = "poke"},
}

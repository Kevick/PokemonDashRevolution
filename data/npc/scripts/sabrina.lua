...
local pokemons = {
{name = "Alakazam", optionalLevel = 400, sex = SEX_MALE, nick = "", ball = "poke"},
{name = "Shiny Hypno", optionalLevel = 400, sex = SEX_MALE, nick = "", ball = "poke"},
{name = "Mr. Mime", optionalLevel = 400, sex = SEX_FEMALE, nick = "", ball = "poke"},
{name = "Porygon", optionalLevel = 400, sex = SEX_FEMALE, nick = "", ball = "poke"},
{name = "Espeon", optionalLevel = 400, sex = SEX_FEMALE, nick = "", ball = "poke"},
}
...
local function doWinDuel(cid, npc)
	...
	setPlayerStorageValue(cid, 995, 1)
end

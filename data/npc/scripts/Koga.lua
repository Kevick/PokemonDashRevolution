...
local pokemons = {
{name = "Arbok", optionalLevel = 750, sex = SEX_FEMALE, nick = "", ball = "poke"},
{name = "Nidoqueen", optionalLevel = 750, sex = SEX_FEMALE, nick = "", ball = "poke"},
{name = "Crobat", optionalLevel = 700, sex = SEX_MALE, nick = "", ball = "poke"},
{name = "Muk", optionalLevel = 700, sex = SEX_MALE, nick = "", ball = "poke"},
{name = "Weezing", optionalLevel = 700, sex = SEX_MALE, nick = "", ball = "poke"},
{name = "Nidoking", optionalLevel = 700, sex = SEX_MALE, nick = "", ball = "poke"},
}

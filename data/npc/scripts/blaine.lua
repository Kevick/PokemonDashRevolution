...
local pokemons = {
{name = "Rapidash", optionalLevel = 300, sex = SEX_FEMALE, nick = "", ball = "poke"},
{name = "Ninetales", optionalLevel = 300, sex = SEX_FEMALE, nick = "", ball = "poke"},
{name = "Flareon", optionalLevel = 300, sex = SEX_FEMALE, nick = "", ball = "poke"},
{name = "Arcanine", optionalLevel = 300, sex = SEX_MALE, nick = "", ball = "poke"},
{name = "Charizard", optionalLevel = 300, sex = SEX_MALE, nick = "", ball = "poke"},
{name = "Magmar", optionalLevel = 300, sex = SEX_MALE, nick = "", ball = "poke"},
}

...
[25696] = {{x = 931, y = 315, z = 7}, 6598754, 113},
[25695] = {{x = 934, y = 313, z = 7}, 6598755, 107},
[25697] = {{x = 898, y = 321, z = 7}},
[25698] = {{x = 896, y = 321, z = 7}},
}
local action = posis[item.actionid]
local out = getPlayerSex(cid) == 0 and 160 or 159
                                                                           --alterado v1.9

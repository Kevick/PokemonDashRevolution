...
function onPokeballsChange(player, freeCapacity)
  if freeCapacity > 6 then return end
  if freeCapacity == 0 then
	pokeballBar:setImageSource('/images/game/pokemon/pokeball0')
  else
	pokeballBar:setImageSource('/images/game/pokemon/pokeball' .. (freeCapacity ~= -1 and freeCapacity or 6))
  end
end
